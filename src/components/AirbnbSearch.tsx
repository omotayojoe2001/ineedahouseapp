...
const AirbnbSearch: React.FC<AirbnbSearchProps> = ({ onSearch }) => {
  ...
  return (
    <div className="relative">
      ...
      {/* Dropdown Panels */}
      {activeField && (
        <div className="absolute top-full left-0 right-0 mt-2 bg-white rounded-3xl shadow-2xl border border-gray-200 p-8 z-50">
